...
def main():
    ...
    parser.add_argument("--base-model", type=str, default="ppo_model_gen2.pt")
    parser.add_argument("--output", type=str, default="ppo_model_gen3.pt")
    ...
    print(f"Starting Gen 3 Self-Play training for {args.episodes} episodes...")
    ...
    # Final Save
    torch.save(model.state_dict(), args.output)
    print(f"\nTraining Complete! Saved final Gen 3 model to {args.output}")
